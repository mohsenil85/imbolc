...
impl SourceType {
    pub fn name(&self) -> &'static str {
        match self {
            ...
            SourceType::Universe => "Universe",
            SourceType::Dreamscape => "Dreamscape",
            SourceType::Soundtrack => "Soundtrack",
    ...
    pub fn from_short_name(s: &str) -> Option<SourceType> {
        match s {
            ...
            "universe" => Some(SourceType::Universe),
            "dreamscape" => Some(SourceType::Dreamscape),
            "soundtrack" => Some(SourceType::Soundtrack),
    ...
    pub fn synth_def_name(&self) -> &'static str {
        match self {
            ...
            SourceType::Universe => "imbolc_universe",
            SourceType::Dreamscape => "imbolc_dreamscape",
            SourceType::Soundtrack => "imbolc_soundtrack",
    ...
    pub fn default_envelope(&self) -> EnvConfig {
        match self {
            ...
            // ROMpler pads: slow attack, long release
            SourceType::Universe | SourceType::Dreamscape | SourceType::Soundtrack => EnvConfig {
                attack: 0.3,
                decay: 0.2,
                sustain: 0.8,
                release: 0.5,
