...
/// Whether a CC mapping was created manually or auto-generated by a tag.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default, Serialize, Deserialize)]
pub enum CcMappingSource {
    #[default]
    Manual,
    Tag,
}
...
pub struct MidiCcMapping {
    ...
    pub max_value: f32,
    /// Whether this mapping was manually created or auto-generated by a tag
    #[serde(default)]
    pub source: CcMappingSource,
}
...
impl MidiCcMapping {
    pub fn new(cc_number: u8, target: AutomationTarget) -> Self {
        ...
        Self {
            ...
            min_value,
            max_value,
            source: CcMappingSource::default(),
        }
    }
