...
pub fn routed_to_network_action(action: &RoutedAction) -> Option<imbolc_net::NetworkAction> {
    ...
    match action {
        RoutedAction::Domain(domain) => match domain {
            ...
            DomainAction::SampleSlicer(a) => Some(NetworkAction::SampleSlicer(a.clone())),
            ...
            DomainAction::Group(a) => Some(NetworkAction::Group(a.clone())),
