...
repl_actions! {
    group "instrument" => DomainAction::Track, InstrumentAction {
        ...
        "cycle-filter-type"        => CycleFilterType(id: TrackId);                               "Cycle to next filter type"
        ...
        "toggle-arp"               => ToggleArp(id: TrackId);                                     "Toggle arpeggiator"
        "cycle-arp-direction"      => CycleArpDirection(id: TrackId);                             "Cycle arp direction forward"
        "cycle-arp-direction-rev"  => CycleArpDirectionReverse(id: TrackId);                      "Cycle arp direction reverse"
        "cycle-arp-rate"           => CycleArpRate(id: TrackId);                                  "Cycle arp rate forward"
        "cycle-arp-rate-rev"       => CycleArpRateReverse(id: TrackId);                           "Cycle arp rate reverse"
        "adjust-arp-octaves"       => AdjustArpOctaves(id: TrackId, d: i8);                       "Adjust arp octave range"
        "adjust-arp-gate"          => AdjustArpGate(id: TrackId, d: f32);                         "Adjust arp gate length"
        "cycle-chord-shape"        => CycleChordShape(id: TrackId);                               "Cycle chord shape forward"
        "cycle-chord-shape-rev"    => CycleChordShapeReverse(id: TrackId);                        "Cycle chord shape reverse"
        ...
        "cycle-track-time-sig"     => CycleTrackTimeSignature(id: TrackId);                       "Cycle track time signature"
