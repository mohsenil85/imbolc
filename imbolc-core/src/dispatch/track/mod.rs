...
pub(super) fn dispatch_instrument(
    ...
    match action {
        ...
        TrackAction::Update(update) => crud::handle_update(state, update),
        ...
        TrackAction::CycleFilterType(id) => filter::handle_cycle_filter_type(state, *id),
        ...
        TrackAction::ToggleArp(_)
        | TrackAction::CycleArpDirection(_)
        | TrackAction::CycleArpDirectionReverse(_)
        | TrackAction::CycleArpRate(_)
        | TrackAction::CycleArpRateReverse(_)
        | TrackAction::AdjustArpOctaves(_, _)
        | TrackAction::AdjustArpGate(_, _)
        | TrackAction::CycleChordShape(_)
        | TrackAction::CycleChordShapeReverse(_)
        ...
        TrackAction::OpenVstEffectParams(instrument_id, effect_id) => {
        ...
        | TrackAction::CycleTrackTimeSignature(_) => groove::dispatch(state, action),
        // LFO actions
