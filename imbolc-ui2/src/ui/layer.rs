...
impl LayerStack {
    ...
    /// Set the buffer layer at position 1 (between global at 0 and mode layers at 2+).
    /// If the layer doesn't exist in the loaded layers, position 1 is left empty.
    pub fn set_buffer_layer(&mut self, layer_name: &'static str) {
        let name = layer_name;
...
mod tests {
    ...
    #[test]
    fn set_buffer_layer_replaces_position_1() {
